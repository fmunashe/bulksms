...
class TotalMessagesSentPending extends BaseWidget
{
    ...
    protected function getStats(): array
    {
        ...
        $messageStatus = $this->filters['messageStatus'] ?? Message::MESSAGE_STATUS_SELECT['Pending'];
